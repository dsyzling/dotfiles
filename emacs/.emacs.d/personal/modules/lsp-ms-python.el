...
(defun ms-python-ignore-event (workspace params)
  "Ignore lsp event which we lsp or we don't currently handle."
  )
...
(defconst ms-python-default-notification-handlers
  (lsp-ht ("python/languageServerStarted" 'ms-python-server-started)
          ...
          ("python/reportProgress" 'ms-python-ignore-event)
          ("python/beginProgress" 'ms-python-ignore-event)
          ("python/endProgress" 'ms-python-ignore-event)))
